      ...
      <div class="input-area">
        ...
        <div class="bottom-bar">
          ...
          <div class="dropdown-wrapper">
            <button class="dropdown-btn" @click=${() => this._providerOpen = !this._providerOpen}>
              ${activeProvider?.icon ?? '🤖'} ${activeProvider?.name ?? 'Provider'}
          ...
          <!-- Model dropdown -->
          <div class="dropdown-wrapper">
            <button class="dropdown-btn" @click=${() => this._modelOpen = !this._modelOpen}>
